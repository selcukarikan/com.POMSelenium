...
public class C03_Raporlama extends utilities.TestBaseRapor {
   AmazonPage amazonPage;
    ...
    public void test1(){
        ...
        WebElement suchBox=Driver.getDriver().findElement(By.id("twotabsearchtextbox"));
    suchBox.sendKeys(ConfigReader.getProperty("amazonArananKelime")+Keys.ENTER);

    extentTest.info("nutella icin arama yapildi");
    //sonuc sayfasinin 1000 den az oldugunu test edelim
        ...
        extentTest.info("sonuc sayisinin 1000 den az oldugu goruldu");
    ...
    public void test2(){
        ...
        //nutella icin arama yapalim
        WebElement suchBox=Driver.getDriver().findElement(By.id("twotabsearchtextbox"));
        suchBox.sendKeys("Samsung"+Keys.ENTER);
